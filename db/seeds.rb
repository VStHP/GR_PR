...
#Delete all database
  ListQuestionAnswer.delete_all
  ExamLesson.delete_all
  Answer.delete_all
  Question.delete_all
...
#Course database
  ...
  Course.create! id: "PHP-B5-2018", name: "Thực tập lập trình Laravel khóa 5 - 2018", program: "Phát triển website",
...
#Lesson Database
  ...
  Lesson.create! name: "Làm quen với ngôn ngữ Ruby", subject_id: "RUBY-BS", test_time: "15", youtube_url: "3gD_lA3ZA5A", description: "Tìm hiểu về ngôn ngữ Ruby và các câu lệnh cơ bản"
  Lesson.create! name: "Cú pháp, lớp và đối tượng của Ruby", subject_id: "RUBY-BS", test_time: "15", youtube_url: "", description: "Tìm hiểu về hướng đối tượng trong ngôn ngữ Ruby"
  Lesson.create! name: "Biến, phép tính và comment trong code Ruby", subject_id: "RUBY-BS", test_time: "15", youtube_url: "", description: "Biến, phép tính và comment trong code Ruby"
  Lesson.create! name: "Vòng lặp và điều kiện trong Ruby", subject_id: "RUBY-BS", test_time: "15", youtube_url: "", description: "Vòng lặp và điều kiện trong Ruby"
  Lesson.create! name: "Array và Hash", subject_id: "RUBY-BS", test_time: "15", youtube_url: "DQ8JF4DPk88", description: "Array và Hash"
  Lesson.create! name: "Module, Block, Procs và Lambda trong Ruby", subject_id: "RUBY-BS", test_time: "15", youtube_url: "", description: "Module, Block, Procs và Lambda trong Ruby"
  Lesson.create! name: "Chapter 1: From zero to deploy", subject_id: "RAILS-Tutorial", test_time: "", youtube_url: "", description: "Chapter 1: From zero to deploy"
  Lesson.create! name: "Chapter 2: A toy app", subject_id: "RAILS-Tutorial", test_time: "", youtube_url: "", description: "Chapter 2: A toy app"
  Lesson.create! name: "Chapter 3: Mostly static pages", subject_id: "RAILS-Tutorial", test_time: "", youtube_url: "", description: "Tìm hiểu về tạo trang tĩnh và cấu trúc xây dựng 1 trang web"
  Lesson.create! name: "Chapter 4: Rails-flavored Ruby", subject_id: "RAILS-Tutorial", test_time: "", youtube_url: "", description: "Chapter 4: Rails-flavored Ruby"
  Lesson.create! name: "Chapter 5: Filling in the layout", subject_id: "RAILS-Tutorial", test_time: "", youtube_url: "", description: "Chapter 5: Filling in the layout"
  Lesson.create! name: "Chapter 6: Modeling user", subject_id: "RAILS-Tutorial", test_time: "", youtube_url: "", description: "Tạo model trong rails"
  Lesson.create! name: "Chapter 7: Sign up", subject_id: "RAILS-Tutorial", test_time: "", youtube_url: "", description: "Coding chức năng đăng ký tài khoản"
  Lesson.create! name: "Chapter 8: Basic login", subject_id: "RAILS-Tutorial", test_time: "", youtube_url: "", description: "Coding chức năng đăng nhập đơn giản"
  Lesson.create! name: "Chapter 9: Advanced login", subject_id: "RAILS-Tutorial", test_time: "", youtube_url: "", description: "Codeing chức năng đăng nhập nâng cao với remember"
  Lesson.create! name: "Chapter 10: Updating, showing, and deleting user", subject_id: "RAILS-Tutorial", test_time: "", youtube_url: "", description: "CRUD trong rails"
  Lesson.create! name: "Chapter 11: Account activation", subject_id: "RAILS-Tutorial", test_time: "", youtube_url: "", description: "Kích hoạt tài khoản trong rails"
...
#Company database
  Company.create! name: "IT stCompany", address: "Tầng 5, tòa nhà Saphia, 222 Lê Duẫn, Hải Châu", city: "Đà Nẵng",
    phone: "02363513333", email: "kltn2018dt@gmail.com", description: "Xin chaoXin chaoXin chaoXin chaoXin chaoXin chaoXin chaoXin chaoXin chaoXin chaoXin chaoXin chaoXin chaoXin chaoXin chaoXin chaoXin chaoXin chaoXin chaoXin chaoXin chao"
